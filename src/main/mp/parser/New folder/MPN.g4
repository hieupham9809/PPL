...
array_type
	: ARRAY LEFTSQUAREBRACKET SUB_OP? INTEGERLITERAL DOUBLEDOT SUB_OP? INTEGERLITERAL RIGHTSQUAREBRACKET OF primitive_type
	;
...
assignment_statement
    : ((IDENTIFIERS | exp6) ASSIGN_OP)+  expression SEMICOLON
    ;
