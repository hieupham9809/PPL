...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\2\2\7\2\4\6\b\n\2\3\3\2\5\6\2%\2\f\3\2\2\2\4\27\3\2\2")
        ...
        buf.write("\2\2\2\37\t\3\2\2\2 !\7\24\2\2!#\7\b\2\2\"$\5\b\5\2#\"")
...
class MPParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'main'", "<INVALID>", "'int'", "'void'", 
                     "<INVALID>", "'('", "')'", "'{'", "'}'", "';'" ]

    symbolicNames = [ "<INVALID>", "<INVALID>", "AB", "INTTYPE", "VOIDTYPE", 
                      "INTLIT", "LB", "RB", "LP", "RP", "SEMI", "WS", "BLOCKCOM_B", 
